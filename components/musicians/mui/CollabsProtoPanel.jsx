...
export default function CollabsProtoPanel() {
  const [userPosts, setUserPosts] = useState([])
  const [title, setTitle] = useState('')
  const [body, setBody] = useState('')
  const [city, setCity] = useState('Lecce')
    ...
    <section className="space-y-8" aria-labelledby="collabs-heading">
      <div>
        ...
        <p className="mt-1 text-xs text-muted-foreground">
          Project posts (mock + your browser-saved posts). Similar to “describe your project and let collaborators find
          you”.
        </p>
      </div>
